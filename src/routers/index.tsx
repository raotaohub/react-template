...
const Expenses = SuspenseComponent(React.lazy(() => import('@components/expenses')))
const Home = SuspenseComponent(React.lazy(() => import('@components/home')))
const Invoice = SuspenseComponent(React.lazy(() => import('@components/invoice')))
const Invoices = SuspenseComponent(React.lazy(() => import('@components/invoices')))
        ...
        children: [
          {
            ...
            element: (
              <div>
                ...
                <p>https://reactrouter.com/en/main/start/concepts#index-routes</p>
              </div>
            ),
          },
          {
